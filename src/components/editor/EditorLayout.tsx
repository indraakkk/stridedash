  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside className="flex w-64 shrink-0 flex-col border-r border-border bg-card/80 backdrop-blur-sm">
          <ScrollShadow>
            {/* Upload section */}
        ...
        {/* Main preview area */}
        <main ref={mainRef} className="flex flex-1 items-center justify-center bg-background p-4">
        {hasVideo ? (
          <div
            className="relative"
